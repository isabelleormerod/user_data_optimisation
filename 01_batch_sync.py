...
Usage:
    ...
    python 01_batch_sync.py --json-folder A:\Automated_chain_BETA\Participant_Landmarks --boris-folder A:\Automated_chain_BETA\BORIS_csvs --participants 3 --skip-sync
